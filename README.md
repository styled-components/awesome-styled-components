...
---
### Real Apps
* [njt.now.sh](https://njt.now.sh) - `njt`: npm jump to 🐸 (package navigation shortcuts you dreamed about). Uses Next.js, involves server-side-rendering (SSR) ([source](https://github.com/kachkaev/njt)).
